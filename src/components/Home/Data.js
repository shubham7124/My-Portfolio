...
export default function Data() {
    return (
        <div className='home__data'>
            <h1 className='home__title '>Shubham Sutar
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className='home__description'>
                I'm creativ web  designer based in India , and I'm very Passionate and Dedicated to my Work.
            </p>
            <a href='#contact__card' className='button  button--flex'>
                Say Hello
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
