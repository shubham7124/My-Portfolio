...
export default function () {
  ...
  window.addEventListener("scroll", function () {
    ...
    // when the scroll is higher than 200 viewpoint height, add the .header tag .
      ...
      <nav className='nav container'>
        ...
        <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className='nav__list grid'>
            ...
            <li className='nav__item'>
              <a href='#servieces' onClick={()=>setActiveNav('#servieces')} className={
                                                                  activeNav === "#servieces" ? "nav__link active-link":
                                                                  "nav__link active-link"
                                                                }>
                <i className='uil uil-briefcase nav__icon'></i>Certification
              </a>
            </li>
